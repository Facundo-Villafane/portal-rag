...
export async function middleware(request: NextRequest) {
    ...
    if (
        ...
        !request.nextUrl.pathname.startsWith('/api/chat') && // Allow chat endpoint for public/widget access (subject to rate limits)
        !request.nextUrl.pathname.startsWith('/') // Allow landing page
    ) {
        // Check specific protected paths, e.g. /admin, /dashboard
